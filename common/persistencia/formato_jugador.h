...
#include <cstdint>
 ...
 - vidaMax, manaMax: se pueden recalcular a partir de la raza, clase, nivel y constitución/inteligencia
 - recuperacionVidaPendiente, recuperaciondManaPendiente, meditacionManaPendiente: no es necesario guardarlos, se pueden recalcular a partir de la experiencia y el tiempo que ha pasado desde la última vez que se guardó el jugador
 */
