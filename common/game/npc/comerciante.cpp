...
Comerciante::Comerciante(uint16_t id, Posicion posicion) :
        Npc(id, TipoNpc::Comerciante, posicion), itemsDisponibles({}) {}
...
// El comerciante le COMPRA al jugador (el jugador vende): el jugador recibe el precio de venta (el
// menor). itemsDisponibles guarda {precioCompraJugador, precioVentaJugador}.
...
// El comerciante le VENDE al jugador (el jugador compra): el jugador paga el precio de compra (el
// mayor).
