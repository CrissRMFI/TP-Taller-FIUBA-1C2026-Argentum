...
Window {
    ...
    Image {
        ...
        source: {
            switch (raza) {
                case "Elfo": return `../../assets/imgs/${pngCabezaIndexElfo}.png`;
                case "Enano": return `../../assets/imgs/${pngCabezaIndexEnano}.png`;
                case "Gnomo": return `../../assets/imgs/${pngCabezaIndexGnomo}.png`;
                case "Humano":
                default: return `../../assets/imgs/${pngCabezaIndexHumano}.png`;
            }
        }
    ...
    Image {
        ...
        source: {
            switch (raza) {
                case "Elfo": return `../../assets/imgs/${pngCuerpoIndexElfo}.png`;
                case "Enano": return `../../assets/imgs/${pngCuerpoIndexEnano}.png`;
                case "Gnomo": return `../../assets/imgs/${pngCuerpoIndexGnomo}.png`;
                case "Humano":
                default: return `../../assets/imgs/${pngCuerpoIndexHumano}.png`;
            }
        }
