...
MenuController::MenuController() : audio(std::make_unique<GestorAudioMenu>()) {
    configurarAudio();
}
...
void MenuController::configurarAudio() {
    ...
    audio->configurarMusicaPrincipal(
            QUrl(QStringLiteral("qrc:/QmlCppExample/client/Qt/instrumental/38.wav")));
    audio->registrarEfecto(
            "click", QUrl(QStringLiteral("qrc:/QmlCppExample/client/Qt/instrumental/463.wav")));
    audio->registrarEfecto(
            "volver", QUrl(QStringLiteral("qrc:/QmlCppExample/client/Qt/instrumental/210.wav")));
    audio->registrarEfecto(
            "error", QUrl(QStringLiteral("qrc:/QmlCppExample/client/Qt/instrumental/24.wav")));
}
...
void MenuController::setVentana(QQuickView* ventana_view) {
    this->ventana = ventana_view;
}
