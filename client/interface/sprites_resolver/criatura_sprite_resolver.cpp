...
CreatureSpriteResolver::CreatureSpriteResolver(const SpriteCatalog& catalog, TextureCache& cache) :
        catalog_(catalog), cache_(cache) {}

ResolvedCreatureSprite CreatureSpriteResolver::resolved_creature(
