...
// Una entrada del stock de un comerciante: que item vende, a que precio lo vende (compra, lo que
// paga el jugador) y a que precio lo recompra (venta).
...
struct ConfigJuego {
    ...
    // Posicion ancla donde aparecen los jugadores al conectarse. La celda real la resuelve Juego al
    // conectar (puede ser una vecina si esta ocupada).
